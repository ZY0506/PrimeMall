...
// 查询售后详情
func AfterSaleDetailHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := aftersale.NewAfterSaleDetailLogic(r.Context(), svcCtx)
		resp, err := l.AfterSaleDetail(&req)
		if err != nil {
